...
const PUBLIC_PATHS = ["/", "/login", "/signup", "/api/stripe/webhook", "/auth/callback", "/preview-heroes", "/terms", "/privacy", "/about", "/methodology", "/notify", "/notify/join", "/api/waitlist", "/admin/waitlist", "/api/sms/send-nudges"];
